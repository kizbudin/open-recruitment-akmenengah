...
?>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url(); ?>assets/adminlte/dist/img/LOGO_LABAMENd.png" class="img-circle" alt="User Image">
        </div>
  ...
  <footer class="main-footer">
    ...
    Copyright &copy;<script>document.write(new Date().getFullYear());</script> Lab. Akuntansi Menengah
  </footer>
