...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="callout callout-info">
      ...
      <p>Pastikan sudah membaca syarat pendaftaran sebelumnya</p>
    </div>
    <?php $this->load->view('layouts/notifikasi'); ?>
    
    <?php echo form_open('registrasi/verifikasi_tahap1'); ?>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" maxlength="9" minlength="9" name="nim"  placeholder="NPM" data-inputmask='"mask": "999999999"' data-mask required>
