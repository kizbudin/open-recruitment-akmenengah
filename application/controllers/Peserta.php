...
class Peserta extends CI_Controller {
	...
	public function acak_soal()
	{
		...
		if ($id_p == "") {
			...
			//exit;
			//Jenis Soal
			$soal = $this->M_jenis_soal->data_jenis_soal1($id_peserta)->result();
			...
			for ($i=0; $i < $panjang; $i++) { 
				...
				//Pertanyaan
				// $data ['id_peserta'] = $this->M_nilai->acak_soal($id_peserta)->result();
				$x = $this->M_pertanyaan->acak_soal($id_soal,$id_peserta,$id_lab)->result();
	...
	public function ujian_cat($no_soal)
	{
		...
		$data ['peserta']	= $this->M_peserta->data_peserta($id_peserta,$id_lab)->result();
