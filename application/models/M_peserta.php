...
class M_peserta extends CI_model {
	...
	*/
	...
	private $column_order = array(null, 'id_peserta', 'id_lab','nim', 'nama_peserta', 'region', 'ipk', 'berkas_peserta', 'tgl_selesai_pendaftaran','status_verifikasi'); //set column field database for datatable orderable
	private $column_search = array('id_peserta', 'id_lab','nim', 'nama_peserta', 'region', 'ipk', 'berkas_peserta', 'tgl_selesai_pendaftaran','status_verifikasi'); //set column field database for datatable searchable 
	...
	*/
	...
	public function cetak_peserta($id_lab){
		...
		$this->db->select('nim, nama_peserta, ipk, region');
		$this->db->from('tbl_peserta');
